...
window.smartqasa.versionLoader = "6.1.68-beta.3";
console.info(`%c SmartQasa Loader ⏏ ` + "6.1.68-beta.3" + ` (Built: ` + "2026-02-26T16:43:00.303Z" + `) `, 'background-color: #0000ff; color: #ffffff; font-weight: 700;');
