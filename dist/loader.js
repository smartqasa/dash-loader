...
let PanelCard = class PanelCard extends i$1 {
    ...
    render() {
      ...
      `;
        ...
        return x `
      <div class=${e(containerClass)}>${this.mainCard}</div>
    `;
    }
    firstUpdated() {
        this.createMainCard();
...
ScreenSaver = __decorate([
    t$1("screensaver-card")
], ScreenSaver);

window.smartqasa = window.smartqasa || {};
console.info(`%c SmartQasa Loader ⏏ ${"6.1.14-beta.8"} (Built: ${"2025-09-21T15:59:35.311Z"}) `, "background-color: #0000ff; color: #ffffff; font-weight: 700;");
