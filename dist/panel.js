...
let PanelCard = class PanelCard extends r$2 {
    ...
    render() {
        ...
        return x `${o(`<smartqasa-main-card .config=${this._config} .hass=${this.hass}></smartqasa-main-card>`)}`;
    }
    _testElementsLoaded() {
